# Atualização do GitHub — POKECARD Brasil 3.4.0
...
4. No GitHub Desktop, confira as alterações, faça o commit `POKECARD Brasil 3.4.0 - variações contextuais` e envie para `main`.
...
Não altere `applicationId` nem os Secrets de assinatura. Esta versão usa `versionCode 69` e `versionName 3.4.0`.
